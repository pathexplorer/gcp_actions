...
def show_table(all_stage_times, pipeline_type: str):
    ...
    # Stage Name column: 35 characters, left-aligned (<)
    ...
    # This ensures the text inside the quotes is exactly 35 characters wide.
    # Note: The entire final string will be longer than 35 characters.
    total_line = f"**{text_to_pad:<35}** {total_time:>10.3f}"
